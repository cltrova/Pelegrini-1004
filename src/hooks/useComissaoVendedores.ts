...
export function mapComissaoLinha(row: any): ComissaoLinha {
  ...
  return {
    ...
    faturadoAteHoje: num(pick(row, 'acumulada', 'Acumulada', 'valor_acumulado', 'ValorAcumulado', 'faturado_ate_hoje', 'FaturadoAteHoje', 'faturado')),
    aFaturar: num(pick(row, 'a_faturar', 'AFaturar')),
    valorTotal: vendaTotal || num(pick(row, 'valor_total', 'ValorTotal', 'total')),
    pedidosAberto: num(pick(row, 'pedidos_em_aberto', 'pedidos_aberto', 'PedidosEmAberto')),
    projecao: num(pick(row, 'projecao', 'Projecao')),
    novaProjecao: num(pick(row, 'nova_projecao', 'NovaProjecao')),
